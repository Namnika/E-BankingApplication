            ...
            <section className="dashboard-overview">
                ...
                <div className="widgets-container">
                    <div className="widget">
                        ...
                        <p className="balance-amount">Rs.0.00</p> {/* Replace with actual balance */}
                    ...
                    <div className="widget">
                        ...
                        <ul className="qustions-actions-list">
                            <li><button>Make a Transfer</button></li>
                            <li><button>Add Beneficiary</button></li>
                            <li><button>View Recent Activity</button></li>
                        </ul>
                    </div>
                </div>
            </section>
